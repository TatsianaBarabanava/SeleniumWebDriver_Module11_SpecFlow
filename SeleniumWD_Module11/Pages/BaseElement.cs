...
namespace SeleniumWebDriver
{
    public class BaseElement : IWebElement
    {
        ...
        {
            return new WebDriverWait(Browser.GetDriver(), TimeSpan.FromSeconds(Browser.timeoutForElement)).Until(d => Browser.GetDriver().FindElement(_locator).Displayed);
        }
        ...
        {
            WaitForIsVisible();
            new Actions(Browser.GetDriver()).Click(Browser.GetDriver().FindElement(_locator)).Build().Perform();
        }
